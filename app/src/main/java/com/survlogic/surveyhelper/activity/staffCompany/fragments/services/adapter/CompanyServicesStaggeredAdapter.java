package com.survlogic.surveyhelper.activity.staffCompany.fragments.services.adapter;
...
public class CompanyServicesStaggeredAdapter extends RecyclerView.Adapter<CompanyServicesStaggeredAdapter.ViewHolder> {
    ...
    public CompanyServicesStaggeredAdapter(Context context, ArrayList<String> names, ArrayList<String> imageUrls) {
        mNames = names;
