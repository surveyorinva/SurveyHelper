package com.survlogic.surveyhelper.activity.staffFeed.view.event.photo;
...
public class EventPhotoAdapter extends ArrayAdapter {
    ...
    public EventPhotoAdapter(Context context, int layoutResource, ArrayList<String> images) {
    ...
    public int getCount() {
        ...
        arrayListCount = mEventPhotos.size(); //counts the total number of elements from the arrayList.
