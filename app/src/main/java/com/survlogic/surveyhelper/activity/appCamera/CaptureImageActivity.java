...
import com.survlogic.surveyhelper.activity.appCamera.view.AutoFitTextureView;
...
public class CaptureImageActivity extends AppCompatActivity implements
    ...
    /**
     * An {@link com.survlogic.surveyhelper.activity.appCamera.view.AutoFitTextureView} for camera preview.
     */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.camera_capture_image);
    ...
    private void openCamera(int width, int height) {
        Log.d(TAG, "to_delete: Opening Camera ");
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface, mImageReader.getSurface()),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigureFailed(
                            ...
                            DialogUtils.showToast(mContext,getResources().getString(R.string.camera_error_configuration));
                        }
                    }, null
            );
        } catch (CameraAccessException e) {
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                                               @NonNull CaptureRequest request,
                                               @NonNull TotalCaptureResult result) {
                    DialogUtils.showToast(mContext,"Saved: " + mFile);
